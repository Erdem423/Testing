...
const gate = skipUnless(check, "RACE-T3: Metadata races and parallel load", "Every race tier drives its own throwaway connection and catalog concurrently, so it needs a token to create them.");
