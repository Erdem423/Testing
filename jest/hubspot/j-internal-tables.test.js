...
const gate = skipUnless(check, "J: Internal Table Endpoints", "This one reads the shared catalog only - it needs no HubSpot token, just the connector's own settings.");
