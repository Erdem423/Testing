...
const gate = skipUnless(check, "G: Connection Endpoints", "Creating a HubSpot connection IS this scenario's subject - there is no version of it that runs without a token.");
